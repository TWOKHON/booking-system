  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-x-0 bottom-3.5">
        <div className="ml-47">
          <p className="text-xs text-muted-foreground font-medium">Sunday, Apr 19, 2026</p>
          <h3 className="text-2xl font-bold mb-2">Goodafternoon, Kyle Andre! <span className="waving-hand">👋</span></h3>
        </div>
