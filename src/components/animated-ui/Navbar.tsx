...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-3 z-99 w-full", className)}
    >
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-60 mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start bg-transparent py-4 px-4 lg:flex dark:bg-transparent",
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <img src="/main/logo-light.png" alt="logo" width={30} height={30} />
