...
export function Safari({
  ...
  return (
    <div
      className={`relative inline-block rounded-none w-full align-middle leading-none ${className ?? ""}`}
      style={{
      ...
      {!hasVideo && imageSrc && (
        ...
        >
          <img
            src={imageSrc}
            alt=""
            className="block size-full object-center"
          />
        </div>
      )}
      ...
      >
        ...
        >
          ...
          <circle
            ...
            cy="25"
            r="6"
            className="fill-[#fb2c36]"
          />
          <circle
            cx="47"
            cy="25"
            r="6"
            className="fill-[#f0b100]"
          />
          <circle
            cx="67"
            cy="25"
