...
const executionNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    description: "Create a calendar event or schedule follow-up",
    icon: "/brands/google-calendar.svg",
  },
  {
    type: NodeType.TRELLO,
    label: "Trello",
    description: "Create a task card for resort operations",
    icon: "/brands/trello.svg",
  },
  {
    type: NodeType.INSTAGRAM,
    label: "Instagram",
    description: "Publish an Instagram post with caption and media",
