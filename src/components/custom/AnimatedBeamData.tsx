...
import { AnimatedBeam } from "@/components/animated-ui/AnimatedBeam";
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamData({ className }: { className?: string }) {
...
const Icons = {
  ...
  openai: () => (
    <Image src="/main/logo-light.png" alt="Logo" width={100} height={100} />
  ),
  googleDrive: () => (
    <svg
      width="100"
